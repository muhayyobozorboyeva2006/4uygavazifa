...
function SideborLayout({ openSidebar, setopenSidebar }) {
    ...
    return (
        <>
            <div >
                <aside
                    class={`fixed left-0 top-0 h-screen bg-white border-r border-gray-200 transition-all duration-300 z-20  ${openSidebar ? "w-64" : "w-20"} duration-300`}>
                    <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <h1 className={`text-black ${openSidebar ? "" : "hidden"}`}>EduAdmin</h1>
                        </div>
                    ...
                    <nav class="p-4 space-y-2">
                        <Link to="/dashoard"
                            ...
                            <h1 className={`${openSidebar ? "" : "hidden"}`}>Dashboard</h1>
                        </Link>
                        ...
                        <Link to="/teachers"
                            ...
                            <h1 className={`${openSidebar ? "" : "hidden"}`}>Teachers</h1>
                        </Link>
                        ...
                        <Link to="/students"
                            ...
                            <h1 className={`${openSidebar ? "" : "hidden"} `}>Students</h1>
                        </Link>
                        ...
                        <Link to="./settings.html"
                            ...
                            <h1 className={`${openSidebar ? "" : "hidden"}`}>Settings</h1>
                        </Link>
                        <button onClick={logout}
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all ${openSidebar ? "" : "hidden"}  duration-200 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-600 hover:text-white hover:shadow-lg shadow-blue-500/50`}>
                            Logout</button>
                    </nav>
                </aside>
            </div>
